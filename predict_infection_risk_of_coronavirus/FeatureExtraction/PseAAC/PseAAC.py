...
if __name__ == "__main__":
  for lambdaValue in range(1, 21):
    fastas1 = readFasta.readFasta(r"data.fasta")
    result, header = PseAAC(fastas1, lambdaValue , **kw)
    ...
    data_PseAAC.to_csv('PseAAC_data_lambda_{}.csv'.format(lambdaValue))
    data_PseAAC_name.to_csv('PseAAC_data_name_lambda_{}.csv'.format(lambdaValue))
